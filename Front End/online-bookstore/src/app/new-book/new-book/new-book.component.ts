...
export class NewBookComponent implements OnInit {
 ...
 form: FormGroup = this.formBuilder.group({
  ...
  constructor(private formBuilder: FormBuilder,private route:ActivatedRoute, private http:HttpClient,
    private readonly newbookservice:NewBookService) { }
  ...
  ngOnInit(): void {
    ...
    if(this.edit){
      ...
      this.editBook.minimumQuantity=50
      this.editBook.publicationYear=2022
      this.editBook.publisher="Veroo"
      this.editBook.sellingPrice=300
      ...
      this.f['publicationYear'].setValue(this.editBook.publicationYear)
      this.f['price'].setValue(this.editBook.sellingPrice)
      this.f['category'].setValue(this.editBook.category)
      this.f['minimumQuantity'].setValue(this.editBook.minimumQuantity)
      this.f['bookCover'].setValue(this.editBook.imageLink)
      this.imageLink=this.editBook.imageLink
    }
    ...
    //         this.http.get("http://localhost:8080/posts/info/"+params.data.toString()).subscribe((data:any) =>{
    //           this.editPost=data
  ...
  onSubmit():void{
    ...
    this.newBook.fillData(this.f['ISBN'].value,this.f['title'].value,this.array,this.f['Publisher'].value,
                          ...
                          this.f['bookCover'].value,this.f['minimumQuantity'].value)
